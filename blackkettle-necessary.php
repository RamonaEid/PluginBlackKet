...
function blackkettle_init() {
    ...
    wp_register_script( 'blackkettle-full', plugins_url('js/blackkettle_full.js', __FILE__), array('jquery'), '081416', true );
...
function blackkettle_enqueue_scripts() {
    ...
    wp_enqueue_script( 'blackkettle-full', plugins_url('js/blackkettle_full.js', __FILE__), array('jquery'), '081416', true );
